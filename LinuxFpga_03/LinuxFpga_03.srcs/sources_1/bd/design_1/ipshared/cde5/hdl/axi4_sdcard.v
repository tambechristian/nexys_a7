...
//`include "sdcard.v" //must be commented out to avoid overwriting critical warning errors.
//`include "lib\clog2.v"
//`undef SDCARDSPIMODE
...
module axi4sdcard (
	...
	parameter C_S_AXI_ACLK_FREQ_HZ = 100000000; //100000000
	parameter C_S_AXI_MEM0_BASEADDR	= 32'hffffffff; //32'h44A00000; //
	
	parameter C_S_AXI_BASEADDR = 32'h44A00000;
	parameter C_S_AXI_HIGHADDR = 32'h44A0FFFF;
	//parameter SUPPORTS_NARROW_BURST =0;
	...
	wire DEVRDY;
	wire [C_S_AXI_ADDR_WIDTH -1 : 2] AXI_MEMADDR;
	
	 //= {S_AXI_ARVALID ? S_AXI_ARADDR : S_AXI_AWADDR} ;
	
	assign AXI_MEMADDR = {S_AXI_ARVALID ? S_AXI_ARADDR : S_AXI_AWADDR - C_S_AXI_MEM0_BASEADDR};
	...
	sdcard #(
		...
		.rst (~S_AXI_ARESETN), //used to be ~S_AXI_ARESETN
