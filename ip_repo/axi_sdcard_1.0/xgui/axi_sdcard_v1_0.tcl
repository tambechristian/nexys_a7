...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S_AXI_ARUSER_WIDTH"
  ipgui::add_param $IPINST -name "C_S_AXI_AWUSER_WIDTH"
  ipgui::add_param $IPINST -name "C_S_AXI_WUSER_WIDTH"
  ipgui::add_param $IPINST -name "C_S_AXI_RUSER_WIDTH"
  ipgui::add_param $IPINST -name "C_S_AXI_BUSER_WIDTH"
